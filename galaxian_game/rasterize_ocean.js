...
function alien(){
    ...
    {
        vertices: [[0.55, -0.55, 0.7],[0.55, -0.3, 0.7],[0.75, -0.55, 0.7],[0.75, -0.3, 0.7]],
...
function projectile(){
    return[ {
        vertices: [[0.65, -0.5, 0.7],[0.65, -0.4, 0.7],[0.75, -0.5, 0.7],[0.75, -0.4, 0.7]],
        triangles:[[0,1,2],[1,2,3]],
        material:{
            ambient: [0.1, 0.0, 0.0],
                diffuse: [0.6, 0.0, 0.0],
...
function animateAliens() {
    ...
    for (let i = 0; i < total_aliens; i++) {
        ...
        //alien_projectile.translation = alien.translation;
        //spaceship_projectile.translation[1] = spaceship.translation[1];
    }
